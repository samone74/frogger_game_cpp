...
Car::Car(const float x, const float y, const float speed, const Color color, const float width, const float height,
...
Rectangle Car::get_rect() { return Rectangle(m_x, m_y, m_width, m_height); }
