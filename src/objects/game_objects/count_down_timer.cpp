...
CountDownTimer::CountDownTimer(const SdlContext &context, const Uint32 time_left) : m_time_left(
        time_left * 1000) {
    ...
    float m_x = 50;
    m_y = 0;
    m_draw_object = std::make_unique<TextDrawObject>(context.renderer(), "Time left: " +
                                                                         std::to_string(
                                                                                 m_time_left /
                                                                                 1000), font_file,
