...
std::unordered_map<SDL_Keycode, std::function<void()>> Frog::get_key_down_map() {
    std::unordered_map<SDL_Keycode, std::function<void()>> key_map = {{SDLK_RIGHT, [this]() { start_move_right(); }},
...
std::unordered_map<SDL_Keycode, std::function<void()>> Frog::get_key_up_map() {
    std::unordered_map<SDL_Keycode, std::function<void()>> key_map = {{SDLK_RIGHT, [this]() { stop_move_right(); }},
